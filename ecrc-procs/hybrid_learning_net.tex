...
automatically.
We propose $h(x)$ with the form as following,
\begin{equation}
...
This equation~\ref{eq:15} may become the 
...
Though a multi-objective problem may not have 
a global solution, however in HLNs,
...
algorithm, we obtain the parameter updating
rules,
\begin{equation}
x
\end{equation}
