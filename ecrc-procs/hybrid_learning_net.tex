...
However, neural networks are customly 
...
For Fig.(\ref{fig:4:b}) with a deeper architecture,
...
Let's focus on  
Fig.(\ref{fig:4:d}), where the HLN takes about 120
...
Fig.(\ref{fig:6}) shows the neuron activation
